...
import com.funtube.Adapters.UserAdapter;
...
import com.funtube.ui.fragement.UserFragment;
...
public class UserActivity extends AppCompatActivity {
    ...
    private TextView text_view_status_count_activity_user, verify_account;
    ...
    private void initView() {
        ...
        this.verify_account = findViewById(R.id.verify_account);
    ...
    private void initAction() {
        ...
        this.verify_account.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(UserActivity.this, ActivityRequestAccountVerification.class));
            }
        });
